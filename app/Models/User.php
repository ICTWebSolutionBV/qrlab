...
#[Fillable(['name', 'first_name', 'last_name', 'email', 'password', 'role', 'theme_preference', 'two_factor_secret', 'two_factor_recovery_codes', 'two_factor_confirmed_at', 'two_factor_email_enabled'])]
